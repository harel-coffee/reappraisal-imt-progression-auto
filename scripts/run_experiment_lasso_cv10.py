...
def run(X, y, cv_outer = StratifiedKFoldReg(n_splits=10, shuffle=True, random_state=10), n_alphas = 1000):
...
def run_transform(X, y,  transform, cv_outer =  StratifiedKFoldReg(n_splits=10, shuffle=True, random_state=10), n_alphas = 1000):
...
def main():
    ...
    # Build classifier
    cv_outer = StratifiedKFoldReg(n_splits=10, shuffle=True, random_state=10)
